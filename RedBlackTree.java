...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        if(parent.context[1]!=child && parent.context[2]!=child || child==null || parent==null){
            throw new IllegalArgumentException("Invalid inputs!");
        }
        if(this.root.equals(parent)){
            if(child.isRightChild()){
                Node<T> z=child.context[1];
                this.root=child;
                parent.context[2]=null;
                this.root.context[1]=parent;
                parent.context[2]=z;
            }
            else if(child.isLeftChild()){
                Node<T> z=child.context[2];
                this.root=child;
                parent.context[1]=null;
                this.root.context[2]=parent;
                parent.context[1]=z;
            }
        }
        else{
            ...
            if(child.isRightChild()&&parent.isLeftChild()){
            ...
            //not tested
            if(child.isLeftChild()&&parent.isRightChild()){
                grandparent.context[2]=child;
                Node<T> z=child.context[2];
                parent.context[1]=null;
